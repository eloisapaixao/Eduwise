            ...
            >
                ...
                >
                    ...
                    <Typography variant="body1" align="center" gutterBottom sx={{ color: '#848484'}}>
                        Desfrute dos recursos disponíveis!
                    </Typography>
                    ...
                    <Box component="form" sx={{ width: '100%' }}>
                        ...
                        <Typography variant="body2" align="center" sx={{ mt: 2, color: '#7a7a7a' }}>
                            Eu li e concordo com os <a href="#termos" style={{ color: '#6200ea' }}>Termos de Uso</a> e a <a href="#politica" style={{ color: '#6200ea' }}>Política de Privacidade</a>.
                        </Typography>
                    </Box>
